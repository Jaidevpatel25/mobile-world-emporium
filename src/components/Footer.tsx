    ...
    <footer className="bg-gray-50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-heading text-lg font-bold mb-4">PhoneHub</h3>
            <p className="text-sm text-gray-600 mb-4">
              Your trusted destination for premium smartphones from all major brands.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/contact" className="text-sm text-gray-600 hover:text-primary-700">Contact Us</Link></li>
              <li><Link to="/faq" className="text-sm text-gray-600 hover:text-primary-700">FAQs</Link></li>
