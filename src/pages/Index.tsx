              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    ...
                    asChild
                  >
                    <Link to="/phones">Shop All Phones</Link>
                  </Button>
                  <Button 
                    size="lg" 
                    variant="outline" 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-gray-600">Free delivery within 48 hours for all orders over $500.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="font-heading text-lg font-semibold mb-2">Secure Payment</h3>
